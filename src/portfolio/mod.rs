...
pub struct PortfolioConfig {
    ...
    /// Gain above entry (percent) at which `MOMENTUM_INITIAL_STOP_PCT` is RELEASED and the
    /// trailing stop takes over. `0` (default) = any tick above entry releases it, which is
